...
# Sheet ID canonico + pestanas — fuente unica config_reglas.py (MASTER_RULES §3.1).
# 2026-05-07: deduplicado SHEET_ID. 2026-05-12: deduplicadas pestanas.
from config_reglas import (  # noqa: E402
    SHEET_BD_ID as SHEET_ID,
    SHEET_PESTANA_REGISTROS as WORKSHEET_SRC,
    SHEET_PESTANA_DESTINO as WORKSHEET_DST,
)
